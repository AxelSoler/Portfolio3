...
const ContactForm = () => {
  ...
  return (
    <section
      ...
      id="contact"
    >
      <div className="w-full lg:p-16 bg-gray-600/30 dark:bg-black/60 shadow-[0_6px_25px_rgba(0,0,0,0.5)] dark:shadow-[0_6px_25px_rgba(59,130,246,0.25)] rounded-2xl mx-auto flex flex-col items-center">
        <form
